...
Questo è solo l’inizio [^1] della catena disumanizzante: l’aspirante lavoratore deve produrre una sintesi competitiva di sé, poi qualcun altro deve ipotizzare cosa sappia fare questa persona. È già un filtro brutale quando umano, ma nella così detta era dell’automazione in cui dovremmo essere, questo sistema automatizzato non ascolta, ma classifica in una lista dal quale prendere i primi tre - cinque candidati per le fasi successive.[^2]

## Rompiamo il circuito
...
> Mappare per conoscere, ascoltre per capire, e ricevere confidenze per reagire.
>
> — La prima fase del piano operativo.

Ed è per questo che contestualmente abbiamo aperto due canali anonimi per raccogliere testimonianze. Il primo è pensato per chi lavora o ha lavorato in un'azienda che ne ha fatto uso. Che si tratti di un software specializzato o della cattiva pratica di far valutare i curriculum a ChatGPT, è indifferente, [queste sono le testimonianze che vogliamo raccogliere]():

{{< sezione sfondo="#00e5ff" titolo="Risorse Veramente Umane" >}}

# Sei a conoscenza dell'uso di sistemi automatizzati per la selezione del personale?

### [Confidati con noi](https://raccontaci.nina.watch/#/submission?context=7d9371df-1a40-4d83-9cf8-84b8abd8fe03), stiamo cercando di mappare il fenomeno.
{{< /sezione >}}

Il secondo canale è pensato per [chi sà (certezza o sensazione) di aver subito a suo malgrado una decisione automatizzata](https://raccontaci.nina.watch/#/submission?context=bd218cf7-066b-483d-ab03-b14d715484a1): 


{{< sezione sfondo="#c8f500" titolo="Tu non sei il tuo curriculum" >}}

# Un sistema automatizzato è stato usato per valutare una tua candidatura?

### [Raccontaci](https://raccontaci.nina.watch/#/submission?context=bd218cf7-066b-483d-ab03-b14d715484a1)! potremo scoprire che non sei la sola.
...
Chi cerca lavoro e chi supporta l'iniziativa arriverà ad applicare, in modo coordinato[^3], a luoghi in cui l'automazione processa le candidatura[^4]. Trasformare un processo necessario in rumore puro. Un sistema anti-umano verrà costretto a pagare il prezzo della propria astrazione: più chiamate, più colloqui inconcludenti, più assunzioni sbagliate[^5], più tempo bruciato da entrambe le parti. Quando l’errore diventa sistemico e misurabile, smette di essere sfortuna individuale e diventa questione politica.
