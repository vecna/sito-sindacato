...
Campagne di attivismo come *Reclaim Your Face*[^1] denunciano da anni questa deriva tecno-autoritaria, hanno spinto il Parlamento Europeo a prendere in considerazione il problema, e si è anche arrivati ufficialmente ad una messa al bando di questa pratica.
...
Per questo serve continuare ad organizzare una reazione radicale e dal basso contro la biometria di massa[^2].
...
{{< sezione sfondo="#00e5ff" titolo="Una webapp che ti insegna a truccarti e ti assiste negli esperimenti" >}}

# [Ghòstati!](https://sindacato.nina.watch/ghostati) e diventa un fantasma agli occhi della *Computer Vision*

[Software libero](https://github.com/vecna/ghostati), che funziona su ogni browser e non riceve alcun dato relativo ai tuoi esperimenti.
...
### [Raccontacelo: è fondamentale per aggiornare le forme di resistenza](https://raccontaci.nina.watch/#/submission?context=10c78596-3ea0-4867-b2fb-21fdb8e3f40c)

{{< /sezione >}}

## Eventi in arrivo al NINA Festival

Con noi ci sarà [Michelle Tylicki](https://www.michelletylicki.info/)
...
{{<linked_image
	...
	alt="Workshop di trucco avverso Sabato Pomeriggio al Rob de Matt, Milano"
>}}
...
{{<linked_image
	...
	alt="Workshop di trucco avverso Evento Really Human Resources di domenica a Roma"
>}}
...
[^5]: Ghòstati! su github [vecna/ghostati](https://github.com/vecna/ghostati).
